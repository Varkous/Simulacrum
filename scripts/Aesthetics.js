...
function dismissElement (element, axis, direction, duration = '60%', hide) {
  ...
  //Turns duration (which is a string of a number percentage) into an integer, divided into a 1 digit float number. The lower the percentage (and the number), the less the duration
